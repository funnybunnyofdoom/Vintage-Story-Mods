    ...
    public override void StartServerSide(ICoreServerAPI api)
    {
        ...
        api.RegisterCommand("rtp", "Randomly Teleports the player", "",
            (IServerPlayer player, int groupId, CmdArgs args) =>
            {
                ...
                IWorldAccessor Aworld = api.World; //Add a world accessor to get our sea level. This should allow us to account for higher worlds
                ...
                if (count == 0)
                {
                    ...
                    byEntity.TeleportTo(randx, (Aworld.SeaLevel*2), randz); //Adding the sea level to 199 to get us 199 over sea level for high worlds
                    count = 10;
                    myAPI = api;
