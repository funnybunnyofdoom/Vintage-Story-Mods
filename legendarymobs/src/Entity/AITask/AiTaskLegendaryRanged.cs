...
{
    public class AiTaskLegendaryRanged : AiTaskBaseTargetable
    {
        int durationMs;
        int releaseAtMs;
        ...
        public AiTaskLegendaryRanged(EntityAgent entity) : base(entity)
        {
        }
        ...
        public override bool ContinueExecute(float dt)
        {
            ...
            if (accum > releaseAtMs / 1000f && !didThrow)
            {
                ...
                EntityProperties type = entity.World.GetEntityType(new AssetLocation("magicProjectile"));
