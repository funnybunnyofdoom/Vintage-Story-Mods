...
namespace rocksalt.src
{
    class Snowshovel : Item
    {
        ...
        {
            BlockPos tempPos = new BlockPos(0);
        ...
        public override bool OnBlockBrokenWith(IWorldAccessor world, Entity byEntity, ItemSlot itemslot, BlockSelection blockSel, float dropQuantityMultiplier = 1)
        {
            ...
            {
                EnumBlockMaterial material = byEntity.World.GetBlock(new AssetLocation("game:snowblock")).BlockMaterial; //Snow
                EnumBlockMaterial material2 = byEntity.World.GetBlock(new AssetLocation("game:snowblock")).BlockMaterial; //Snow
